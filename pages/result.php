 <?php 
    // Thực hiện truy vấn SQL để lấy thông tin bài thi có ID = $examId
    $examId = $_GET['id'];
        ...
        <div class="row col-md-6 float-left">
        	<div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <?php 
                        // truy vấn dữ liệu vào bảng exam_question_tbl với bảng exam_answers
                    	...
                    	// phần này sẽ duyệt từng câu hỏi. Biến i sẽ dùng để đánh số thứ tự câu hỏi
                        // Vòng lặp while duyệt qua từng dòng dữ liệu trả về từ truy vấn, mỗi dòng chứa thông tin của một câu hỏi 
                        // và đáp án liên quan.
                        $i = 1;
                    	while ($selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                    		<tr>
                    			<td>
                                    <!-- Hiển thị nội dung câu hỏi và i++ sẽ in theo thứ tăng dần của câu hỏi-->
                ...
                <div class="widget-content-wrapper text-white">
                    ...
                    <div class="widget-content-right">
                        <div class="widget-numbers text-white">
                            <!-- phần này nó sẽ truy vấn câu trả lời đúng  -->
                            <?php 
