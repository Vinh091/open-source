        ...
        <div class="app-header__logo">
            <a href="home.php" style="text-decoration: none;">
                <div class="logo-text" style="display: flex; align-items: center;">
                    <i class="fa fa-leaf" style="font-size: 24px; color: #4CAF50; margin-right: 8px;"></i>
                    <h3 style="margin: 0; font-weight: bold; color: #4CAF50; font-family: 'Arial', sans-serif;">Bokas</h3>
                </div>
            </a>
